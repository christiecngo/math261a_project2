...
```{r fig-boxplot, echo=FALSE}
#| fig-width: 4
#| fig-height: 3
#| fig-cap: "Boxplots for Distributions of Cross-Validation (k=10) RMSE. Democrat (top) and Republican (bottom)"
...
Though each plot in @fig-boxplot shows a wide, overlapping range of RMSE values, we will use the median of each. This is the LASSO model for Democrats and full model for Republicans. The stepwise variable selection performed the most poorly for both, especially for Republicans.
